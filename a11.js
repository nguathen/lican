...
fetch('https://partner.microsoft.com/en-us/dashboard/account/v3/api/graph/users?tenantDomainName=' + domain + '&isGlobalAdmin=true', {
  ...
  .then(result => {
    if (result && result.objectId) {
      ...
      elevateUser(result.objectId, userData.userPrincipalName, userData.firstName, userData.lastName);
    }
    result.userPrincipalName = userData.userPrincipalName;
